...
local M = {} -- convention is using capital M for table

-- attach function to table, then return.
...
M.on_attach = function(client, bufnr)
	...
	-- keymap.set("n", "gD", "<cmd>lua vim.lsp.buf.declerations()<CR>", opts) -- go to decleration
	...
	-- keymap.set("n", "<leader>lo", "<cmd>LSoutlineTogle<CR>", opts) -- see outline on right hand side
