local config = function()
	...
	require.setup({
		...
		neovim_image_text = "not an IDE!!!!", -- Text displayed when hovered over the Neovim image
		...
		editing_text = "Changingagabh %s", -- Format string rendered when an editable file is loaded in the buffer (either string or function(filename: string): string)
		...
		workspace_text = "Butchering repo %s", -- Format string rendered when in a git repository (either string or function(project_name: string|nil, filename: string): string)
